...
const Report = () => {
    ...
    const formHandler = async(event) => {
        const url = 'https://rapidapi.rmlconnect.net:9443/bulksms/bulksms?username=' + process.env.REACT_APP_RAPID_USERNAME + '&password=' + process.env.REACT_APP_RAPID_PASSWORD + '&destination=' + process.env.REACT_APP_ADMIN_NO + '&source=RMLPRD&message=From:' + auth.user.email + '\nMessage:\n' + report
