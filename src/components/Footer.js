...
const Footer = () => {
  return (
    <>
      <footer
        className="px-4 divide-y bg-coolGray-100 text-white"
        style={{
          ...
          <div className="grid grid-cols-2 text-sm gap-x-3 gap-y-8 lg:w-2/3 sm:grid-cols-4">
            <div className="space-y-3">
              ...
              <ul className="space-y-1">
                ...
                <li>
                  <p className="cursor-pointer">Hospital</p>
                </li>
                <li>
            ...
            <div className="space-y-3">
              <h3 className="uppercase text-coolGray-900">Security</h3>
              <ul className="space-y-1">
                <li>
                  <a href="https://www.ibm.com/in-en/topics/what-is-blockchain" target="_blank">BlockChain</a>
                </li>
                <li>
            ...
            <div className="space-y-3">
              ...
              <div className="flex justify-start space-x-3">
                ...
                <a href="https://twitter.com/iammoniesh208" target="_blank" title="Twitter" className="flex items-center p-1 text-white bg-white">
                  <svg
                    viewBox="0 0 24 24"
                    xmlns="http://www.w3.org/2000/svg"
                    className="w-5 h-5 fillCurrent"
                ...
                <a href="https://www.instagram.com/iammoniesh208/" target="_blank" title="Instagram" className="flex items-center p-1">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    viewBox="0 0 32 32"
                    fill="currentColor"
