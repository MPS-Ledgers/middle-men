						...
						<div class="w-full md:max-w-md mt-6">
							<div class="card bg-white shadow-md rounded-lg px-4 py-4 mb-6 ">
								<form onSubmit={loginHandler}>
									...
									}} type="text" class="rounded px-4 w-full py-1 bg-gray-200  border border-gray-400 mb-6 text-gray-700 placeholder-gray-700 focus:bg-white focus:outline-none" placeholder="Email Number" />
									<input onChange={(event) => {
								...
								{loginError ?
									<div className="loginerror text-center text-red-500">Invalid Email or Password</div> : <></>}
							</div>
						</div>
					</div>
				</div>
